...
# create the legendre polynomial for the gauss quadrature for n > 10
# for n <` 10 we will use the predefined values in the dictionary
...
def main():
    ...
    print(f'because the number of intervals required for the trapezoidal rule method is very high, we jump each iteration by 100000, we start from 100000')
    n_trapz = n
